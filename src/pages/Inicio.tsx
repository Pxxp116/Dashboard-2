  ...
  const statsData = [
    {
      ...
      icon: Calendar,
      color: 'blue' as const,
      trend: (estadoSistema.reservas_hoy > (estadoSistema.reservas_ayer || 0)) ? 'positive' as const : 'neutral' as const,
    ...
    },
    {
      ...
      trend: ((estadoSistema.mesas_ocupadas / estadoSistema.mesas_totales) > 0.7) ? 'positive' as const : 'neutral' as const,
        ...
        <div className="glass-card-lg p-8">
          ...
          <div className="space-y-4">
            {!estadoSistema?.proximas_reservas?.length ? (
              ...
              estadoSistema.proximas_reservas.slice(0, 4).map((reserva: any, index: number) => (
                <div
                  key={index}
